...
I presented a modular pipeline for structured menu extraction combining OCR with hybrid classification approaches. The key finding is that \textbf{domain mismatch} between receipt-trained models and menu images is the primary accuracy bottleneck---ML models achieving 91\% accuracy on CORD-v2 drop to $<$30\% F1 on menus. Domain-specific rule-based classification with lexical priors and hierarchy constraints achieves 35.6\% F1 score and 38.9\% price accuracy, outperforming all tested ML approaches.
